# Compliance Issue Map — the $21 credit + referral model

> **NOT LEGAL ADVICE.** A sourced issue map for licensed counsel to work from. Items marked **[ATTORNEY]** require a licensed practitioner in the relevant state.
