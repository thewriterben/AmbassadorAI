...
A complete first run, in plain English. Budget about an hour.
...
Keep jargon out, or define it the second you use it. Want a starting draft? The Idea
generator's **prompt set** gives you a ready script prompt to paste into any AI chat.

## Step 3 — Make the visuals
...
Put these on screen in the first few seconds (details: [disclosures explained](disclosures-explained.md)):

1. **"Not financial advice"** — always.
2. **"Sponsored" / #Ad** — if you're recognized or rewarded for posting.
3. **An AI label** — if you used a realistic AI voice or avatar.
...
That's it — a compliant, educational DGD video. The second one is twice as fast.
