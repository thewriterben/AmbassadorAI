...
1. **[The Golden Rules of communication](compliance/communications-discipline.md)** — what you can and can't say. Non-negotiable.
2. **[What is Digital Gold? (overview)](dgd/dgd-overview.md)** — the subject you're teaching.
3. **[Approved talking points](dgd/approved-talking-points.md)** — safe, accurate things to say on camera.
4. **[The free toolkit](tools/toolkit-overview.md)** — every tool you need, $0.
5. **[Your first video in one afternoon](tools/workflows.md)** — an end-to-end free workflow.
6. **[Pre-publish checklist](templates/pre-publish-checklist.md)** — run this before every post.

## The wiki at a glance

| Folder | What's in it |
|---|---|
| [`dgd/`](index.md#digital-gold-subject-knowledge) | What Digital Gold is — pillars, valuation, supply, pathways, glossary, talking points |
| [`compliance/`](index.md#compliance) | Foundation discipline, FTC disclosure, AI-content labels, TikTok/IG/YouTube/X policies |
| [`tools/`](index.md#free-ai-toolkit) | Free AI tools by job: scripting, voiceover, video, images, captions, music, full workflows |
| [`craft/`](index.md#craft--viral-strategy) | Hooks, story structures, what makes short-form spread, platform specs |
| [`prompts/`](index.md#prompt-library) | Copy-paste prompts for scripts, images, video, and voiceover |
| [`templates/`](index.md#templates) | Content calendar, video brief, series ideas, pre-publish checklist |
